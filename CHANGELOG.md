...
- Release the trusted-edge TierGuard research implementation.
- Add matched two-level HFL-FedAvg, FLTrust, trimmed-mean, and RFA baselines.
- Freeze a 180-run confirmatory matrix with six held-out paired seeds.
